...
from models.common.random_projection import SparseRandomProjection
...
class KCenterGreedy:
    ...
    def __init__(self, embedding: Tensor, sampling_ratio: float):
    ...
    def update_distances(self, cluster_centers: List[int]):
    ...
    def select_coreset_idxs(self, selected_idxs: Optional[List[int]] = None):
    ...
    def sample_coreset(self, selected_idxs: Optional[List[int]] = None):
