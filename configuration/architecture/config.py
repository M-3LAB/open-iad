...
def parse_arguments_centralized():
    ...
    parser.add_argument('--model', '-m', type=str, default='dne', choices=['patchcore', 'csflow', 'dne', 'draem', 'igd', 'cutpaste', 'devnet', 'dra', 
                                                                              'favae', 'padim', 'reverse', 'spade', 'fastflow', 'softpatch', 'cfa', 'stpm'])
    parser.add_argument('--net', '-n', type=str, default='vit_b_16', choices=['wide_resnet50', 'resnet18', 'net_csflow', 'vit_b_16', 'net_draem', 'net_dra',
    ...
    parser.add_argument('--train-task-id', '-tid', type=int, default=[1, 11], nargs='+')
    parser.add_argument('--valid-task-id', '-vid', type=int, default=[1, 11], nargs='+')
