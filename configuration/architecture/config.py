...
def parse_arguments_centralized():
    ...
    parser.add_argument('--model', '-m', type=str, default='dne', choices=['patchcore2d', 'csflow', 'dne', 'draem', 'igd', 'cutpaste', 'devnet', 'dra'])
    parser.add_argument('--net', '-n', type=str, default='vit_b_16', choices=['wide_resnet50', 'resnet18', 'net_csflow', 'vit_b_16', 'net_draem', 'net_dra', 'net_igd'])
